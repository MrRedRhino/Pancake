...
public class OrderedJSONObject extends JSONObject {
     ...
     */
    public OrderedJSONObject(Map<?, ?> m, JSONParserConfiguration jsonParserConfiguration) {
     ...
     */
    private OrderedJSONObject(Map<?, ?> m, int recursionDepth, JSONParserConfiguration jsonParserConfiguration) {
    ...
    private OrderedJSONObject(Object bean, Set<Object> objectsRecord) {
        this();
    ...
    private static Object wrap(Object object, Set<Object> objectsRecord, int recursionDepth, JSONParserConfiguration jsonParserConfiguration) {
        try {
            ...
            if (object instanceof Map) {
                Map<?, ?> map = (Map<?, ?>) object;
                return new OrderedJSONObject(map, recursionDepth, jsonParserConfiguration);
            }
            ...
            if (objectsRecord != null) {
                return new OrderedJSONObject(object, objectsRecord);
            }
